 ...
 * Stub hash: 1deec7286b18b11504f2c0f5039a6594f0806aee */
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_Cbor_Undefined_get, 0, 0, Cbor\\\125ndefined, 0)
ZEND_END_ARG_INFO()
...
#define arginfo_class_Cbor_Decoder_getBuffer arginfo_class_Cbor_FloatX_toBinary
...
static const zend_function_entry class_Cbor_FloatX_methods[] = {
	...
	ZEND_ME(Cbor_FloatX, toBinary, arginfo_class_Cbor_FloatX_toBinary, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};
