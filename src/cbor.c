...
#define REG_CLASS_CONST_LONG(cls, prefix, name)  zend_declare_class_constant_long(CBOR_CE(cls), ZEND_STRL(#name), prefix##name);
	...
	REG_CLASS_CONST_LONG(tag, PHP_CBOR_TAG_, SHAREABLE);
	REG_CLASS_CONST_LONG(tag, PHP_CBOR_TAG_, SHARED_REF);
	REG_CLASS_CONST_LONG(tag, PHP_CBOR_TAG_, DATETIME);
	REG_CLASS_CONST_LONG(tag, PHP_CBOR_TAG_, BIGNUM_U);
	REG_CLASS_CONST_LONG(tag, PHP_CBOR_TAG_, BIGNUM_N);
	REG_CLASS_CONST_LONG(tag, PHP_CBOR_TAG_, DECIMAL);
	/* tag constants end */
